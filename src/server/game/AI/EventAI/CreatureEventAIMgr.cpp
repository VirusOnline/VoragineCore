...
void CreatureEventAIMgr::LoadCreatureEventAI_Texts()
{
    ...
    // Load EventAI Text
    sObjectMgr->LoadVoragineStrings("creature_ai_texts",MIN_CREATURE_AI_TEXT_STRING_ID,MAX_CREATURE_AI_TEXT_STRING_ID);
    ...
    do
    {
        ...
        if (!sObjectMgr->GetVoragineStringLocale(i))
        {
...
void CreatureEventAIMgr::LoadCreatureEventAI_Summons()
{
    ...
    do
    {
        ...
        if (!Voragine::IsValidMapCoord(temp.position_x,temp.position_y,temp.position_z,temp.orientation))
        {
