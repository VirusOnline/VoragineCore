...
// INSERT INTO `spell_script_names` (`spell_id`, `ScriptName`) VALUES (73159, 'spell_worgen_last_stand_movie');
class spell_worgen_last_stand_movie : public SpellScriptLoader
{
    public:
        ...
        class spell_worgen_last_stand_movie_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                OnEffect += SpellEffectFn(spell_worgen_last_stand_movie_SpellScript::HandleScript, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
            }
        };
