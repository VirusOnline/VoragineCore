...
-- The Lich King
UPDATE `creature_template` SET `faction_A` = 974, `faction_H` = 974, `speed_walk` = 2, `speed_run` = 1.71429, `unit_flags` = 768, `mechanic_immune_mask` = 667631615 WHERE `entry` IN (36597, 39166, 39167, 39168);
...
-- Tirion Fordring
UPDATE `creature_template` SET `mindmg` = 468, `maxdmg` = 702, `attackpower` = 175, `dmg_multiplier` = 47.2, `rangeattacktime` = 2000, `unit_class` = 2, `minrangedmg` = 374, `maxrangedmg` = 562, `rangedattackpower` = 140, `mechanic_immune_mask` = 12584976 WHERE `entry` = 38995;
-- Val'kyr Shadowguard
UPDATE `creature_template` SET `minlevel` = 81, `maxlevel` = 81, `faction_A` = 14, `faction_H` = 14, `speed_walk` = 2, `speed_run` = 1.71429, `mindmg` = 318, `maxdmg` = 478, `attackpower` = 119, `dmg_multiplier` = 2, `baseattacktime` = 2000, `rangeattacktime` = 2000, `unit_class` = 8, `unit_flags` = 33554944, `dynamicflags` = 8, `minrangedmg` = 254, `maxrangedmg` = 382, `rangedattackpower` = 95, `mechanic_immune_mask` = 12584976 WHERE `entry` IN (36609, 39120, 39121, 39122);
-- Vile Spirit
...
-- Raging Spirit
UPDATE `creature_template` SET `minlevel` = 83, `maxlevel` = 83, `faction_A` = 14, `faction_H` = 14, `speed_walk` = 2, `speed_run` = 1.42857, `mindmg` = 468, `maxdmg` = 702, `attackpower` = 175, `dmg_multiplier` = 47.2, `baseattacktime` = 2000, `rangeattacktime` = 2000, `dynamicflags` = 8, `minrangedmg` = 374, `maxrangedmg` = 562, `rangedattackpower` = 140, `mechanic_immune_mask` = 12584976 WHERE `entry` IN (36701, 39302, 39303, 39304);
-- Ice Sphere
UPDATE `creature_template` SET `minlevel` = 83, `maxlevel` = 83, `faction_A` = 14, `faction_H` = 14, `speed_walk` = 1.2, `speed_run` = 0.428571, `mindmg` = 468, `maxdmg` = 702, `attackpower` = 175, `dmg_multiplier` = 47.2, `baseattacktime` = 2000, `rangeattacktime` = 2000, `dynamicflags` = 8, `minrangedmg` = 374, `maxrangedmg` = 562, `rangedattackpower` = 140, `mechanic_immune_mask` = 12584976 WHERE `entry` IN (36633, 39305, 39306, 39307);
-- Defile
UPDATE `creature_template` SET `minlevel` = 81, `maxlevel` = 81, `faction_A` = 14, `faction_H` = 14, `speed_walk` = 1.2, `speed_run` = 0.428571, `mindmg` = 436, `maxdmg` = 654, `attackpower` = 163, `dmg_multiplier` = 2, `baseattacktime` = 2000, `rangeattacktime` = 2000, `unit_flags` = 33554944, `minrangedmg` = 349, `maxrangedmg` = 523, `rangedattackpower` = 130, `mechanic_immune_mask` = 12584976 WHERE `entry` = 38757;
-- Spirit Warden
UPDATE `creature_template` SET `minlevel` = 80, `maxlevel` = 80, `faction_A` = 14, `faction_H` = 14, `speed_walk` = 1, `speed_run` = 1.14286, `mindmg` = 420, `maxdmg` = 630, `attackpower` = 157, `dmg_multiplier` = 2, `baseattacktime` = 2000, `rangeattacktime` = 2000, `dynamicflags` = 8, `minrangedmg` = 336, `maxrangedmg` = 504, `rangedattackpower` = 126 WHERE `entry` IN (36824, 39296);
-- Terenas Menethil
