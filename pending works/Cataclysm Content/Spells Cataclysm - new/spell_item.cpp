...
public:
    ...
    public:
        ...
        bool Validate(SpellEntry const * /*spellEntry*/)
        {
            if (!sSpellStore.LookupEntry(SPELL_FLASK_OF_ENHANCEMENT_IN))
                return false;
            if (!sSpellStore.LookupEntry(SPELL_FLASK_OF_ENHANCEMENT_AG))
                return false;
        ...
        void HandleDummy(SpellEffIndex /*effIndex*/)
        {
            ...
            switch (pCaster->getClass())
            {
                ...
                case CLASS_MAGE:
                case CLASS_PRIEST:
                    possibleSpells.push_back(SPELL_FLASK_OF_ENHANCEMENT_IN);
                    break;
                case CLASS_DEATH_KNIGHT:
                case CLASS_WARRIOR:
                ...
                case CLASS_ROGUE:
                case CLASS_HUNTER:
                    possibleSpells.push_back(SPELL_FLASK_OF_ENHANCEMENT_AG);
                    break;
                case CLASS_PALADIN:
                    possibleSpells.push_back(SPELL_FLASK_OF_ENHANCEMENT_IN);
                    possibleSpells.push_back(SPELL_FLASK_OF_ENHANCEMENT_STR);
...
public:
    ...
    public:
        ...
        void Register()
        {
            OnEffectApply += AuraEffectApplyFn(spell_item_shadowmourne_AuraScript::OnStackChange, EFFECT_0, SPELL_AURA_MOD_STAT, AURA_EFFECT_HANDLE_REAL/*AuraEffectHandleModes(AURA_EFFECT_HANDLE_REAL | AURA_EFFECT_HANDLE_REAPPLY)*/);
