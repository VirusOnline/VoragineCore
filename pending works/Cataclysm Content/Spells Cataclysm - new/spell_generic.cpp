...
class spell_gen_lava_burst_cd_reset : public SpellScriptLoader
{
    public:
        ...
        class spell_gen_lava_burst_cd_reset_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                OnEffect += SpellEffectFn(spell_gen_lava_burst_cd_reset_SpellScript::HandleScript, EFFECT_0, SPELL_EFFECT_DUMMY);
            }
        };
...
class spell_gen_fire_blast_cd_reset : public SpellScriptLoader
{
    public:
        ...
        class spell_gen_fire_blast_cd_reset_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                OnEffect += SpellEffectFn(spell_gen_fire_blast_cd_reset_SpellScript::HandleScript, EFFECT_0, SPELL_EFFECT_APPLY_AURA);
            }
        };
...
class spell_gen_colossus_smash_cd_reset : public SpellScriptLoader
{
    public:
        ...
        class spell_gen_colossus_smash_cd_reset_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                OnEffect += SpellEffectFn(spell_gen_colossus_smash_cd_reset_SpellScript::HandleScript, EFFECT_0, SPELL_EFFECT_APPLY_AURA);
            }
        };
...
enum AvengersShieldSpell
{
    SPELL_AVENGERS_SHIELD          = 31935,
};

// 85416 Grand Crusader!
class spell_gen_grand_crusader : public SpellScriptLoader
{
    public:
        spell_gen_grand_crusader() : SpellScriptLoader("spell_gen_grand_crusader") {}

        class spell_gen_grand_crusader_SpellScript : public SpellScript
        {
            PrepareSpellScript(spell_gen_grand_crusader_SpellScript);

            bool Validate(SpellEntry const* /*spellEntry*/)
            {
                if (!sSpellStore.LookupEntry(SPELL_AVENGERS_SHIELD))
                    return false;
                return true;
            }
            ...
            {
                if (Player *caster = GetCaster()->ToPlayer())
                    if (caster->HasSpellCooldown(SPELL_AVENGERS_SHIELD))
                        caster->RemoveSpellCooldown(SPELL_AVENGERS_SHIELD, true);
            }

            void Register()
            {
                OnEffect += SpellEffectFn(spell_gen_grand_crusader_SpellScript::HandleScript, EFFECT_0, SPELL_EFFECT_APPLY_AURA);
            }
        };

        SpellScript* GetSpellScript() const
        {
            return new spell_gen_grand_crusader_SpellScript();
        }
};
...
class spell_gen_starsurge_cd_reset : public SpellScriptLoader
{
    public:
        ...
        class spell_gen_starsurge_cd_reset_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                OnEffect += SpellEffectFn(spell_gen_starsurge_cd_reset_SpellScript::HandleScript, EFFECT_0, SPELL_EFFECT_APPLY_AURA);
            }
        };
